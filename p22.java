...
import com.google.common.io.Files;
	...
	public class p22
	{
		...
		public static void main(String[] args) throws Exception
		{
			...
			xlRead("C:\\Users\\slk\\Desktop\\sd\\Google.xls");
			for(int i=1;i<xlRows;i++)
			{
				if(xData[i][1].equalsIgnoreCase("Y"))
				{
					...
					else
					{
						...
						File srcFile=(File)((TakesScreenshot)myD).getScreenshotAs(OutputType.FILE);
						Files.copy(srcFile, new File("C:\\Users\\slk\\Desktop\\sd\\pa.jpg"));
						xData[i][5]="C:\\\\Users\\\\slk\\\\Desktop\\\\sd\\\\pa.jpg";
					}
					myD.quit();
				      }
					xlwrite("C:\\Users\\slk\\Desktop\\sd\\result.xls",xData);
